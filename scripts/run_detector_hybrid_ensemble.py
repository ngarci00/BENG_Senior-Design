...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-root", default=repo_path("outputs", "detector_hybrid_ensemble"))
...
def main() -> None:
    ...
    if not args.skip_hybrid:
        run_step("Train/evaluate hybrid SVM branch", [args.python, repo_path("src", "run_SVM", "run.py")], args.dry_run)
