...
from config import (runs_path, epochs, batch_size, learning_rate, weight_decay, 
                    clip_len, clips_per_video_train, clips_per_video_val, stop_if_val_acc_perfect, perfect_acc_tolerance, seed)
