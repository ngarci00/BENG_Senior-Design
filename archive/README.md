...
This directory contains the archived anatomy-tracking and anatomy-detector pipeline.

- Archived source: `archive/src/anatomy_tracking`, `archive/src/anatomy_detection`
- Archived entrypoints: `archive/scripts/run.py`, `archive/scripts/run_detector_hybrid_ensemble.py`
